...
//   token: string;
//   user: {
//     role: 'ADMIN' | 'STUDENT' | 'MIT_CORDINATOR' | 'PARENT' | 'STAFF';
//     username: string;
//   };
// };
type RegisterResponse = {
            ...
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <h1 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                  Digital Feedback & Suggestion Management
                </h1>
              </Link>
              <p className="2xl:px-20">MIT 811 GROUP 4 PROJECT</p>
